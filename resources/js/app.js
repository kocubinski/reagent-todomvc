...
cljs.core.with_meta = function with_meta(b, c) {
  return cljs.core.fn_QMARK_.call(null, b) && !(b ? b.cljs$lang$protocol_mask$partition0$ & 262144 || b.cljs$core$IWithMeta$ || (b.cljs$lang$protocol_mask$partition0$ ? 0 : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) ? with_meta.call(null, function() {
    "undefined" === typeof cljs.core.t5088 && (cljs.core.t5088 = function(b, c, f, g) {
      this.meta = b;
      this.o = c;
      this.with_meta = f;
      this.meta5089 = g;
    ...
    }, cljs.core.t5088.cljs$lang$type = !0, cljs.core.t5088.cljs$lang$ctorStr = "cljs.core/t5088", cljs.core.t5088.cljs$lang$ctorPrWriter = function(b, c, f) {
      return cljs.core._write.call(null, c, "cljs.core/t5088");
    }, cljs.core.t5088.prototype.call = function() {
      var b = function(b, c) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c;
    }(), cljs.core.t5088.prototype.apply = function(b, c) {
      return this.call.apply(this, [this].concat(cljs.core.aclone.call(null, c)));
    }, cljs.core.t5088.prototype.cljs$core$IFn$_invoke$arity$2 = function() {
      var b = function(b) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c;
    }(), cljs.core.t5088.prototype.cljs$core$Fn$ = !0, cljs.core.t5088.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
      return this.meta5089;
    }, cljs.core.t5088.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
      return new cljs.core.t5088(this.meta, this.o, this.with_meta, c);
    }, cljs.core.__GT_t5088 = function(b, c, f, g) {
      return new cljs.core.t5088(b, c, f, g);
    });
    return new cljs.core.t5088(c, b, with_meta, null);
...
var reagent_todomvc = {};
reagent_todomvc.todos = reagent.core.atom.call(null, cljs.core.sorted_map.call(null));
reagent_todomvc.counter = reagent.core.atom.call(null, 0);
reagent_todomvc.add_todo = function(a) {
  var b = cljs.core.swap_BANG_.call(null, reagent_todomvc.counter, cljs.core.inc);
  return cljs.core.swap_BANG_.call(null, reagent_todomvc.todos, cljs.core.assoc, b, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null, "id", "id", 1013907597), b, new cljs.core.Keyword(null, "title", "title", 1124275658), a, new cljs.core.Keyword(null, "done", "done", 1016993524), !1], null));
};
reagent_todomvc.toggle = function(a) {
  return cljs.core.swap_BANG_.call(null, reagent_todomvc.todos, cljs.core.update_in, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a, new cljs.core.Keyword(null, "done", "done", 1016993524)], null), cljs.core.not);
};
reagent_todomvc.save = function(a, b) {
  return cljs.core.swap_BANG_.call(null, reagent_todomvc.todos, cljs.core.assoc_in, new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a, new cljs.core.Keyword(null, "title", "title", 1124275658)], null), b);
};
reagent_todomvc.delete$ = function(a) {
  return cljs.core.swap_BANG_.call(null, reagent_todomvc.todos, cljs.core.dissoc, a);
};
reagent_todomvc.mmap = function(a, b, c) {
  return cljs.core.into.call(null, cljs.core.empty.call(null, a), b.call(null, c, a));
};
reagent_todomvc.complete_all = function(a) {
  return cljs.core.swap_BANG_.call(null, reagent_todomvc.todos, reagent_todomvc.mmap, cljs.core.map, function(b) {
...
reagent_todomvc.clear_done = function() {
  return cljs.core.swap_BANG_.call(null, reagent_todomvc.todos, reagent_todomvc.mmap, cljs.core.remove, function(a) {
...
reagent_todomvc.add_todo.call(null, "Rename Cloact to Reagent");
reagent_todomvc.add_todo.call(null, "Add undo demo");
reagent_todomvc.add_todo.call(null, "Make all rendering async");
reagent_todomvc.add_todo.call(null, "Allow any arguments to component functions");
reagent_todomvc.complete_all.call(null, !0);
reagent_todomvc.todo_input = function(a) {
  a = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
...
reagent_todomvc.todo_edit = cljs.core.with_meta.call(null, reagent_todomvc.todo_input, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "component-did-mount", "component-did-mount", 1606210541), function(a) {
  return reagent.core.dom_node.call(null, a).focus();
}], null));
reagent_todomvc.todo_stats = function(a) {
  ...
  1473224428), new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "on-click", "on-click", 1416542092), reagent_todomvc.clear_done], null), "Clear completed ", a], null) : null], null);
};
reagent_todomvc.todo_item = function() {
  ...
  return function(b) {
    ...
    "div.view", "div.view", 1324225876), new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "input.toggle", "input.toggle", 1637778794), new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null, "type", "type", 1017479852), "checkbox", new cljs.core.Keyword(null, "checked", "checked", 1756218137), d, new cljs.core.Keyword(null, "on-change", "on-change", 606853840), function() {
      return reagent_todomvc.toggle.call(null, e);
      ...
      return reagent_todomvc.delete$.call(null, e);
    }], null)], null)], null), cljs.core.truth_(cljs.core.deref.call(null, a)) ? new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_todomvc.todo_edit, new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null, "class", "class", 1108647146), "edit", new cljs.core.Keyword(null, "title", "title", 1124275658), c, new cljs.core.Keyword(null, "on-save", "on-save", 3936853021), function(a) {
      return reagent_todomvc.save.call(null, e, a);
    }, new cljs.core.Keyword(null, "on-stop", "on-stop", 3936871074), function() {
      return cljs.core.reset_BANG_.call(null, a, !1);
    }], null)], null) : null], null);
  };
};
reagent_todomvc.todo_app = function(a) {
  var b = reagent.core.atom.call(null, new cljs.core.Keyword(null, "all", "all", 1014000915));
  return function() {
    var a = cljs.core.vals.call(null, cljs.core.deref.call(null, reagent_todomvc.todos)), d = cljs.core.count.call(null, cljs.core.filter.call(null, new cljs.core.Keyword(null, "done", "done", 1016993524), a)), e = cljs.core.count.call(null, a) - d;
    ...
    2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "h1", "h1", 1013907515), "todos"], null), new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_todomvc.todo_input, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null, "id", "id", 1013907597), "new-todo", new cljs.core.Keyword(null, "placeholder", "placeholder", 1612151013), "What needs to be done?", new cljs.core.Keyword(null, "on-save", "on-save", 3936853021), reagent_todomvc.add_todo], 
    null)], null)], null), 0 < cljs.core.count.call(null, a) ? new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "div", "div", 1014003715), new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "section#main", "section#main", 1608792073), new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "input#toggle-all", "input#toggle-all", 
    3579251059), new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null, "type", "type", 1017479852), "checkbox", new cljs.core.Keyword(null, "checked", "checked", 1756218137), 0 === e, new cljs.core.Keyword(null, "on-change", "on-change", 606853840), function() {
      return reagent_todomvc.complete_all.call(null, 0 < e);
        ...
        return new cljs.core.LazySeq(null, function() {
          for (;;) {
            ...
            if (b) {
                ...
                a: {
                  for (var p = 0;;) {
                    if (p < d) {
                      ...
                      cljs.core.chunk_append.call(null, e, cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_todomvc.todo_item, q], null), new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "key", "key", 1014010321), (new cljs.core.Keyword(null, "id", "id", 1013907597)).cljs$core$IFn$_invoke$arity$1(q)], null)));
                      p += 1;
                    } else {
                      c = !0;
                      break a;
              ...
              return cljs.core.cons.call(null, cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_todomvc.todo_item, e], null), new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "key", "key", 1014010321), (new cljs.core.Keyword(null, "id", "id", 1013907597)).cljs$core$IFn$_invoke$arity$1(e)], null)), g.call(null, cljs.core.rest.call(null, b)));
            }
            return null;
          }
        }, null, null);
    ...
    }()], null)], null), new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "footer#footer", "footer#footer", 2352584949), new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_todomvc.todo_stats, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null, "active", "active", 3885920888), e, new cljs.core.Keyword(null, "done", "done", 1016993524), d, new cljs.core.Keyword(null, "filt", "filt", 
    1017047293), b], null)], null)], null)], null) : null], null), new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "footer#info", "footer#info", 2056725E3), new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null, "p", "p", 1013904354), "Double-click to edit a todo"], null)], null)], null);
  };
};
reagent_todomvc.run = function() {
  return reagent.core.render_component.call(null, new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_todomvc.todo_app], null), document.body);
};
goog.exportSymbol("reagent_todomvc.run", reagent_todomvc.run);
